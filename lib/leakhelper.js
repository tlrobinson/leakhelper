(function(LeakHelper) {
    ...
    Context.prototype.traverse = function traverse(object, path) {
        var stack = [{ object: object, path : path }];

        while (stack.length > 0) {
            var item = this.dfs ? stack.pop() : stack.shift();
            ...
            if ((type === "object" || type === "function") && object) {
                ...
                Object.keys(properties).forEach(function(property) {
                    if (Object.prototype.hasOwnProperty.call(object, property)) {
                        stack.push({ object: object[property], path : path.concat(property) });
                    }
                }, this);
            }
        }
